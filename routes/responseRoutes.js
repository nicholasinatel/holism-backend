    ...
    return {
      ...
      config: {
        ...
        validate: {
          ...
          headers,
          payload: {
            model_form: Joi.string()
              .min(24)
              .max(24)
              .default(CREATE_DEFAULT.model_form),
            user: Joi.string()
              .min(1)
              .default(CREATE_DEFAULT.user),
  ...
  delete() {
    return {
      ...
      config: {
        ...
        notes:
          'o <b> id </b> deve ser válido, realizar um read no banco antes, passar como <b>String</b>',
        validate: {
          headers,
          failAction,
          params: {
